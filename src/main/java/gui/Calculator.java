...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent event) {
		...
		if (value.equals("0")){
			...
			displayText.setText(sign(value));
		} else if (value.equals("+")) {
			displayText.setText(sign(value));
		} else if (value.equals("-")) {
			displayText.setText(sign(value));
			...
			displayText.setText(Float.toString(opn(displayText.getText())));
			number1="";
			number2="";
			operator="";
	...
	public float opn(String q){
		float a1 = Character.getNumericValue(q.charAt(0));
		float a2 = Character.getNumericValue(q.charAt(2));
	...
	public String sign(String w){
		return number1+w+number2;
	}
